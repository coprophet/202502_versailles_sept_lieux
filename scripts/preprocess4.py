...
if make_graph:
    ...
    plt.plot(all_data[myconfig.field_date], all_data['paris_lutherie1_affluence_base100k'], marker='o', linestyle='-', color='red', label='Number of Transactions')
...
all_data = all_data.rename(columns={'paris_lutherie1_affluence_base100k': myconfig.field_y})

# add a column "y_value" with the value 
all_data[myconfig.field_seriesname]='paris_lutherie1_affluence_base100k'
