...
file_name = file_path+"petitscommerces_bonsdachat.csv"
...
all_data['petitscommerces_bonsdachat_base_100k'] = all_data['amount'] / total_2024 * 100000
...
if make_graph:
    ...
    plt.plot(all_data[myconfig.field_date], all_data['petitscommerces_bonsdachat_base_100k'], marker='o', linestyle='-', color='red', label='Total Revenue')
    ...
    plt.tight_layout()
    plt.savefig(file_path+"petitscommerces_bonsdachat.png")
    plt.close()
...
all_data = all_data.rename(columns={'petitscommerces_bonsdachat_base_100k': myconfig.field_y})

# add a column "y_value" with the value 
all_data[myconfig.field_seriesname]='petitscommerces_bonsdachat_base_100k'
...
all_data.to_csv(myconfig.opendata_path+'petitscommerces_bonsdachat.csv', index=False)

all_train_valid_data = all_data[all_data[myconfig.field_train_valid_test] != 'test']
all_train_valid_data.to_csv(myconfig.git_path+'petitscommerces_bonsdachat.csv', index=False)
